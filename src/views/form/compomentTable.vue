    ...
    <section class="ces-table-page">
        ...
        <section class="ces-table">
            <el-table
                ...
                >
                    <!--<template slot-scope="scope"
                            v-if="item.type === 'bigData'"
                    >
                        <div v-for="bigDataItem in bigData" :key="bigDataItem.id">
                    ...
                    <template slot-scope="scope" >
                        <!-- 按钮-->
                        <span v-for="btnItem in newBtnList" :key="btnItem.id">
                            <span v-if="item.type==='button' && btnItem.id === scope.row.id" >
