            ...
            <div class="ctrolPrintPlace">
              ...
              <div class="three">
                ...
                <div style="width: 158mm;margin: 0px 0 10px 88px;" class="ctroAdvise">
                  ...
                  <!-- <p
                    v-show="!isprint"
                    style="word-wrap:break-word;    text-align: left;    padding-left: 10px;font-size:12px;margin:0;padding: 5px;"
                  >
...
export default {
  ...
  methods: {
    ...
    start(row) {
      ...
      // var h = document.documentElement.clientHeight - 139 + "px";
      //  $("#firstContent").css({
      //    "height": h,
      //    "max-height": h,
      //  });
